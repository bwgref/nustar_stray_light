...
pro make_sky,root=root,obsid=obsid,silent=silent, e1=e1,e2=e2, grade_max=grade_max, evtpath=evtpath, PA=PA, key=key, sky=sky, hdr=hdr, delta=delta, igne1=igne1, igne2=igne2, center_ra=center_ra, center_dec=center_dec
